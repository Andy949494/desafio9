const addProductToCart = (cartId,productId) => {
    ...
    if(cartId === cartIdOK && productId === productIdOK) {
...
const result1 = addProductToCart('1',3);
...
const result2 = addProductToCart('',3);
...
const result3 = addProductToCart(2,'');
...
const result4 = addProductToCart(1,3);
...
const result5 = addProductToCart(2,4);
...
console.log('Test 6: La función debe devolver < Producto agregado correctamente al carrito >');
const result6 = addProductToCart(2,3);
if (result6 === 'Producto agregado correctamente al carrito') {
 console.log('Test 6: Pasado');
 testPasados++;
} else {
 console.error(
  '* Test 6 fails: se esperaba < Producto agregado correctamente al carrito > y se obtuvo',
  result6
 );
}
